...
public class bank_Customer {
    ...
    private static final String[] CUSTOMER_NAMES = {
            "航海王", "玉珠姐", "角頭 龍哥", "草莓姐姐", "Selina", "李宗恆", "青溪姐", "竹科工程師 Tim", "公務員 陳小姐"
    };
    ...
    public static bank_LoanRequest createRequestByName(String name, int rejectCount) {
        switch (name) {
            ...
            case "李宗恆":
                if (rejectCount == 0) {
                    printDialog(name, "初登場", "「那個...我想借 100 萬研發『自動幫你挑股票』的 App，這是我一生的夢想！」");
            ...
            case "青溪姐":
                ...
                // =================================================================
            case "竹科工程師 Tim":
                printDialog(name, "初登場", "「經理您好，我在護國神山擔任設備工程師。因為今年要結婚，看中了竹北一間新成屋，想申請 1200 萬的青年首購房貸。」");
    ...
    public static String getEndGameScript(String name, String status) {
        if ("SUCCESS".equalsIgnoreCase(status)) {
            switch (name) {
                ...
                case "李宗恆": return "「經理！我的暈船App在軟體商店下載量第一名！我把貸款全還清了，我要去跟Threads女神告白了！」";
                case "青溪姐": return "「經理，我們雞排攤現在天天排隊，這筆錢已經連本帶利還清了，真的太謝謝你了！」";
                case "竹科工程師 Tim": return "「房貸都扣款完畢結清了，謝謝銀行的協助，未來有其他理財需要再找你們。」";
            ...
            switch (name) {
                ...
                case "李宗恆": return "⚠️【突發事件】新型AI工具將獨立App完全取代！阿恆憔悴表示：「App被迫下架，資金全燒光，這期真的繳不出來...」";
                case "青溪姐": return "⚠️【突發事件】夜市爆發嚴重食物中毒風波遭勒令停業！青溪姐哭訴：「夜市完全沒人來，我連攤位租金都付不出來了...」";
                case "竹科工程師 Tim": return "⚠️【突發事件】Tim因長期加班住院辭職，又逢科技業寒冬！Tim憔悴地說：「我非自願離職了...目前沒有收入，必須延遲還款...」";
